...
if st.button("Open url in new tab"):
    st.markdown(f'<a href="https://drive.google.com/drive/u/1/folders/1JJlNkktQzv4upA_dUddWtLK3lib8yU0C" target="_blank">Click here to open the URL in a new tab</a>',
